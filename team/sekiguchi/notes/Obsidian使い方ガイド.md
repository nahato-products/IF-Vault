...
このガイドは、sekiguchiさんがObsidianを効率的に使うための手引きです。
...
### デイリーノート
**Cmd + P** → "Templater: Insert template" → `sekiguchi-daily-template`
