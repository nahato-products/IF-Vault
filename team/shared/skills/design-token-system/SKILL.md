...
:root {
  ...
  --foreground: oklch(0.145 0 0);       /* L=0.145, 差=0.855 → 十分 */
  --muted-foreground: oklch(0.556 0 0); /* L=0.556, 差=0.444 → AA OK */
}
```

> L 値の差とコントラスト比の対応表は [reference.md](reference.md) セクション B を参照。
