...
description: "Model threats from repository codebases by enumerating trust boundaries, assets, attacker capabilities, abuse paths, and mitigations, and writes a concise Markdown threat model. Use when the user explicitly asks to threat model a codebase or path, enumerate threats/abuse paths, or perform AppSec threat modeling. Do not trigger for general architecture summaries, code review, or non-security design work."
...
- **_security-review**: 脆弱性スキャン・OWASP パターン検出との連携
- **_security-best-practices**: セキュアコーディングのベストプラクティス適用
- **security-arsenal**: 脅威モデルに基づく攻撃的テスト（Red Team）の実行
