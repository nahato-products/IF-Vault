...
## docker init によるスキャフォールディング

`docker init` で対話的にDockerfile / compose.yaml / .dockerignore を自動生成できる。新規プロジェクトのDocker化はここから始めるのが効率的。

## Task 6: Dockerfile Layer Caching Example
...
## Task 8: Docker Compose Service Orchestration (Full Example)
...
## Task 10: Resource Management & Health Check
